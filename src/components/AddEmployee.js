...
function AddEmployee({ newEmployee }) {
  ...
  return (
    <>
      <button
        onClick={handleShow}
        className="block mx-auto m-2 shadow bg-purple-500 hover:bg-purple-800 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"
      >
        + Add Employee
      </button>
      <Modal
      ...
      >
        ...
        <Modal.Body>
          <form
            onSubmit={(e) => {
              e.preventDefault();
              newEmployee(emp_name, emp_role, emp_img);
              setEmp_name("");
              setEmp_role("");
              setEmp_img("");
            }}
            ...
            <div className="md:flex md:items-center mb-6">
              ...
              <div className="md:w-2/3">
                <input
                  className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                  id="img"
                  placeholder="https://images.pexels.com/photos/2117283/pexels-photo-2117283.jpeg"
                  type="text"
                  value={emp_img}
                  onChange={(e) => {
                    setEmp_img(e.target.value);
                  }}
                />
              </div>
            </div>
